...
import com.boys.assets.musicplayer.activity.music.adapter.SongAdapter
...
import com.boys.assets.musicplayer.activity.music.model.SongModel
import com.boys.assets.musicplayer.activity.music.vm.MusicViewModel
import com.boys.assets.musicplayer.databinding.ActivitySearchBinding
...
class SearchActivity : AppCompatActivity(), SearchOnClickListener<MusicResultModel> {
    ...
    private var listSongs= ArrayList<SongModel>()
    ...
    override fun onItemClick(itemBinding: ActivitySearchListItemBinding, position: Int, model: MusicResultModel) {
        ...
        if (musicResultModel.isPlay){
            ...
            try {
                ...
                Log.e("MySongAdapter", "Error: " + ex.message)
            }
        }
    }
